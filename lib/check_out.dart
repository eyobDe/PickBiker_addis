                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (equalsIgnoreCase(
                          ...
                          setState(() {
                            deliveryDiscount =
                                double.parse(data['discount_by_percent']);
                          });
                        } else {
                ...
                switch (snapshotRest.connectionState) {
                  ...
                  default:
                    if (snapshotRest.hasError) {
                      ...
                      var distance = myLocationPoint.haversineDistance(lat: Restlat, lng: Restlong);
...
// total distance
                        ...
                        return ((Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Center(
                                child: Text(
                                  "We accept payment in cash or by mobile money.For more, please call on 9857. Thanks for choosing PickDelivery",
                                  textAlign: TextAlign.right,
                                  style: TextStyle(
                                    fontWeight: FontWeight.w400,
                                    fontSize: 14,
  ...
  //var rng = new Random();
  var l = new List.generate(4, (_) => Random().nextInt(100));
  ...
  double totalPriceFinal,
    ...
    return orders
        .add({
          'order_num': code,
          'cuisine_id': widget.menu.id, // John Doe
        ...
        .then((value) => showAlertDialogForSuccess(this.context))
